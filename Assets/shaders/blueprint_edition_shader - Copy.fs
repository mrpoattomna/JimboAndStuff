...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    float displacement_x = (0.1*cos(blueprint_edition_shader.g*0.3)+0.3)/texture_details.b;
    float displacement_y = (0.03*sin(blueprint_edition_shader.r)+0.03)/texture_details.a;
    ...
    if (blueprint_edition_shader.g > 0.0 || blueprint_edition_shader.g < 0.0) {
        red_tex = RGB(red_tex);
